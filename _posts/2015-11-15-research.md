...
I am an advocate of reproducible science, and I share code and data associated with my research papers (e.g., my paper on [Galerkin approximation of the surface active QG equation](http://git.io/vBe3H)). [The future of research communication is on the browser](http://www.nature.com/news/interactive-notebooks-sharing-the-code-1.16261). I use [Jupyter](http://jupyter.org) notebooks on a daily-basis to share code, data, plots, and text with my advisors and collaborators.
